...
const seedDB = async () => {
  try {
    ...
    const announcementsGroup = await Group.create({
      ...
      description: 'Executive updates, all-hands announcements, and policy briefings (Admin Only Post).',
      createdBy: admin._id,
    ...
    await Message.create([
      {
        ...
        senderId: admin._id,
        type: 'text',
        content: '👋 Welcome to the new SAAS Nexus engineering channel. Sprint goals are loaded in the Tasks board.',
        workspaceId: workspace._id,
      },
      {
        groupId: engineeringGroup._id,
        senderId: sarah._id,
        type: 'text',
        content: 'Awesome! I am implementing the responsive theme system and sidebar navigation today.',
        workspaceId: workspace._id,
      },
      {
        groupId: engineeringGroup._id,
        senderId: david._id,
        type: 'text',
        content: 'Socket.IO event listeners and token middleware endpoints are ready for integration.',
        workspaceId: workspace._id,
      },
      {
        ...
        senderId: admin._id,
        type: 'text',
        content: '🚨 Notice: Q3 Townhall is scheduled this Thursday at 3:00 PM EST. Check your calendar tab for Google Meet links.',
        workspaceId: workspace._id,
      },
    ]);
    ...
    await Task.create([
      {
        ...
        description: 'Ensure all primary indigo (#4F46E5), slate surfaces, and WCAG AA contrast tokens match the spec.',
      ...
      },
      {
        ...
        description: 'Verify server-side chat permissions for adminOnly channels and live broadcast triggers.',
      ...
      },
      {
        ...
        description: 'Automate build triggers and configure secret environment variables on staging.',
      ...
      },
      {
        ...
        description: 'Export SVG icons, avatar placeholders, and empty state illustrations for SAAS Nexus.',
    ...
    await Meeting.create([
      ...
      },
      {
        ...
        description: 'Interactive walkthrough of group chat UI, modals, and responsive layout test.',
        groupId: designGroup._id,
    ...
    await ActivityLog.create([
      {
        ...
        targetType: 'User',
        targetId: sarah._id,
        details: 'Admin Alex Morgan provisioned user account for Sarah Jenkins (Senior Frontend Engineer)',
      ...
      },
      {
        ...
        targetType: 'User',
        targetId: david._id,
        details: 'Admin Alex Morgan provisioned user account for David Chen (Lead Backend Developer)',
      ...
      },
      {
        ...
        targetType: 'User',
        targetId: marcus._id,
        details: 'Admin Alex Morgan provisioned user account for Marcus Vance (Cloud & DevOps Specialist)',
